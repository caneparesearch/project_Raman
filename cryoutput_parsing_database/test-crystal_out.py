...
# Na3PS4 = crystalOut("cryoutput_parsing_database\crystal17_output_files\calc-Ag2HgS2_14_icsd201713_tzvp_PBE0-DONE\Ag2HgS2_14.out")
# print("structure:\n", Na3PS4.structure)
...
convoluted_amplitude = voigt_profile(0, 1, 1)
print(convoluted_amplitude) 